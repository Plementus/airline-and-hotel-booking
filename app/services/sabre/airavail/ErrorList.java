 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.ebxml.org/namespaces/messageHeader}Error" maxOccurs="unbounded"/>
 *         &lt;any processContents='lax' namespace='##other' maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.ebxml.org/namespaces/messageHeader}headerExtension.grp"/>
 *       &lt;attribute name="highestSeverity" use="required" type="{http://www.ebxml.org/namespaces/messageHeader}severity.type" />
...
@XmlRootElement(name = "ErrorList", namespace = "http://www.ebxml.org/namespaces/messageHeader")
public class ErrorList {

    @XmlElement(name = "Error", namespace = "http://www.ebxml.org/namespaces/messageHeader", required = true)
    protected List<java.lang.Error> error;
    @XmlAnyElement(lax = true)
    protected List<Object> any;
    @XmlAttribute(name = "highestSeverity", namespace = "http://www.ebxml.org/namespaces/messageHeader", required = true)
