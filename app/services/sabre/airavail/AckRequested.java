...
@XmlRootElement(name = "AckRequested", namespace = "http://www.ebxml.org/namespaces/messageHeader")
public class AckRequested {
    ...
    @XmlAttribute(name = "signed", namespace = "http://www.ebxml.org/namespaces/messageHeader", required = true)
