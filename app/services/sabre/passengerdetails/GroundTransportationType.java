 ...
 *         &lt;element name="Vendor" type="{http://services.sabre.com/sp/pd/v3_2}CompanyType" minOccurs="0"/>
 *         &lt;element name="Service" type="{http://services.sabre.com/sp/pd/v3_2}ServiceType" minOccurs="0"/>
 *         &lt;element name="ServiceProvider" type="{http://services.sabre.com/sp/pd/v3_2}ServiceProviderType" minOccurs="0"/>
 ...
 *         &lt;element name="ExternalReservation" type="{http://services.sabre.com/sp/pd/v3_2}ExternalReservationType" minOccurs="0"/>
 *         &lt;element name="Restrictions" type="{http://services.sabre.com/sp/pd/v3_2}RestrictionsType" minOccurs="0"/>
 *         &lt;element name="POS" type="{http://services.sabre.com/sp/pd/v3_2}POSType"/>
 *         &lt;element name="AgentLoyalty" type="{http://services.sabre.com/sp/pd/v3_2}LoyaltyType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Passenger" type="{http://services.sabre.com/sp/pd/v3_2}PassengerType" maxOccurs="99" minOccurs="0"/>
 *         &lt;element name="RateQualifier" type="{http://services.sabre.com/sp/pd/v3_2}RateQualifierType" maxOccurs="unbounded" minOccurs="0"/>
