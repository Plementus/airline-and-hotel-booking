 ...
 * 
 */
@WebServiceClient(name = "BargainFinderMaxService", targetNamespace = "https://webservices.sabre.com/websvc", wsdlLocation = "http://files.developer.sabre.com/wsdl/sabreXML1.0.00/shopping/BargainFinderMax_ADRQ_v1-8-6.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://files.developer.sabre.com/wsdl/sabreXML1.0.00/shopping/BargainFinderMax_ADRQ_v1-8-6.wsdl");
