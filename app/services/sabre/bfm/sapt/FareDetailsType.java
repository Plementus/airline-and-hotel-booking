 ...
 *       &lt;attribute name="ComponentNo" use="required" type="{http://www.w3.org/2001/XMLSchema}short" />
 *       &lt;attribute name="BasisCode" use="required" type="{http://www.opentravel.org/OTA/2003/05}FareBasisCodeType" />
...
@XmlType(name = "FareDetailsType")
@XmlSeeAlso({
    ExchangeOriginDestinationFlightType.Fare.class
})
public class FareDetailsType {

    @XmlAttribute(name = "ComponentNo", required = true)
    protected short componentNo;
    @XmlAttribute(name = "BasisCode", required = true)
