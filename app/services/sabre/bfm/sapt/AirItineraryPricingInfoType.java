 ...
 *                   &lt;element name="ValidatingCarrier" type="{http://www.opentravel.org/OTA/2003/05}ValidatingCarrierInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class AirItineraryPricingInfoType {
    ...
    public static class TPAExtensions {
        ...
        protected List<ValidatingCarrierInfoType> validatingCarrier;
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the validatingCarrier property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getValidatingCarrier().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<ValidatingCarrierInfoType> getValidatingCarrier() {
            if (validatingCarrier == null) {
                validatingCarrier = new ArrayList<ValidatingCarrierInfoType>();
            }
