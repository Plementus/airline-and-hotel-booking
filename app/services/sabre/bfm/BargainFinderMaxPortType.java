 ...
 * 
 */
@WebService(name = "BargainFinderMaxPortType", targetNamespace = "https://webservices3.service.sabre.com")
...
public interface BargainFinderMaxPortType {
     ...
     * @param body
     * @return
     *     returns bfm.OTAAirLowFareSearchRS
     */
    @WebMethod(operationName = "BargainFinderMaxRQ", action = "BargainFinderMaxRQ")
    @WebResult(name = "OTA_AirLowFareSearchRS", targetNamespace = "http://www.opentravel.org/OTA/2003/05", partName = "body")
    public OTAAirLowFareSearchRS bargainFinderMaxRQ(
