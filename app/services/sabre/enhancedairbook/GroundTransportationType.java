 ...
 *         &lt;element name="Vendor" type="{http://services.sabre.com/sp/eab/v3_2}CompanyType" minOccurs="0"/>
 *         &lt;element name="Service" type="{http://services.sabre.com/sp/eab/v3_2}ServiceType" minOccurs="0"/>
 *         &lt;element name="ServiceProvider" type="{http://services.sabre.com/sp/eab/v3_2}ServiceProviderType" minOccurs="0"/>
 *         &lt;element name="StartDetails" type="{http://services.sabre.com/sp/eab/v3_2}LocationDetailsType" minOccurs="0"/>
 *         &lt;element name="StopDetails" type="{http://services.sabre.com/sp/eab/v3_2}LocationDetailsType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="EndDetails" type="{http://services.sabre.com/sp/eab/v3_2}LocationDetailsType" minOccurs="0"/>
 *         &lt;element name="ExternalReservation" type="{http://services.sabre.com/sp/eab/v3_2}ExternalReservationType" minOccurs="0"/>
 *         &lt;element name="Restrictions" type="{http://services.sabre.com/sp/eab/v3_2}RestrictionsType" minOccurs="0"/>
 *         &lt;element name="POS" type="{http://services.sabre.com/sp/eab/v3_2}POSType"/>
 *         &lt;element name="AgentLoyalty" type="{http://services.sabre.com/sp/eab/v3_2}LoyaltyType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Passenger" type="{http://services.sabre.com/sp/eab/v3_2}PassengerType" maxOccurs="99" minOccurs="0"/>
 *         &lt;element name="RateQualifier" type="{http://services.sabre.com/sp/eab/v3_2}RateQualifierType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Charges" type="{http://services.sabre.com/sp/eab/v3_2}ChargesType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
