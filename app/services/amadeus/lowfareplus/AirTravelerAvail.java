 ...
 *       &lt;sequence>
 *         &lt;element name="PassengerTypeQuantity" type="{http://traveltalk.com/wsLowFarePlus}PassengerTypeQuantity" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AirTravelerType" type="{http://traveltalk.com/wsLowFarePlus}AirTravelerType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AirTravelerAvail {
    ...
    public List<PassengerTypeQuantity> getPassengerTypeQuantity() {
        if (passengerTypeQuantity == null) {
            passengerTypeQuantity = new ArrayList<>();
        }
