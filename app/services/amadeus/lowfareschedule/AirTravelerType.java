 ...
 *       &lt;sequence>
 *         &lt;element name="ProfileRef" type="{http://traveltalk.com/wsLowFareSchedule}ProfileRef" minOccurs="0"/>
 *         &lt;element name="PersonName" type="{http://traveltalk.com/wsLowFareSchedule}PersonName" minOccurs="0"/>
 *         &lt;element name="Telephone" type="{http://traveltalk.com/wsLowFareSchedule}Telephone" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Email" type="{http://traveltalk.com/wsLowFareSchedule}Email" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Address" type="{http://traveltalk.com/wsLowFareSchedule}Address" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CustLoyalty" type="{http://traveltalk.com/wsLowFareSchedule}CustLoyalty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Document" type="{http://traveltalk.com/wsLowFareSchedule}Document" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PassengerTypeQuantity" type="{http://traveltalk.com/wsLowFareSchedule}PassengerTypeQuantity" minOccurs="0"/>
 *         &lt;element name="TravelerRefNumber" type="{http://traveltalk.com/wsLowFareSchedule}TravelerRefNumber" minOccurs="0"/>
 *         &lt;element name="FlightSegmentRPHs" type="{http://traveltalk.com/wsLowFareSchedule}ArrayOfFlightSegmentRPH" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Gender" type="{http://traveltalk.com/wsLowFareSchedule}AirTravelerTypeGender" />
 *       &lt;attribute name="ShareSynchInd" type="{http://traveltalk.com/wsLowFareSchedule}AirTravelerTypeShareSynchInd" />
 *       &lt;attribute name="ShareMarketInd" type="{http://traveltalk.com/wsLowFareSchedule}AirTravelerTypeShareMarketInd" />
