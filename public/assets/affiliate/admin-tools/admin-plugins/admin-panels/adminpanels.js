...
(function($, window, document, undefined) {
   ...
   $.fn.adminpanel = function(options) {
      ...
      var methods = {
         init: function(options) {
            ...
            // Helper class that adds unique ID's to grid elements
            $(pluginGrid).each(function(i, e) {
               $(e).attr('id', 'grid-' + i);
            });

            // Prep console panel/container prior to menu creation
   ...
   //          // Autoclose mobile menus after 2500 ms
   //          $('.panel-controls').on('shown.bs.popover', function () {
   //          	var This = $(this);
   ...
   //          	if (This.length){
	  ...
	  //           		This.removeClass('panel-controls-open');
	  //           	},2500);
			//   	}
			// });
         ...
         controlHandlers: function(e) {
            ...
            var panelFullscreen = function() {
               ...
               // if not active add fullscreen core and disable panel sorting
               else {
            ...
            var panelRemove = function() {
               ...
               // check for bootbox plugin existance

               if (PNotify) {
                  (new PNotify({
                     addclass: 'console-panel-note',
                     animate_speed: 'fast',
                     title: 'Are you sure?',
                     hide: false,
                     type: 'info',
                     ...
                     confirm: {
                        ...
                        buttons: [{
                           text: "Yup, Do it.",
                           addClass: "btn-sm btn-primary light mt10",
                        }, {
                           text: "Cancel",
